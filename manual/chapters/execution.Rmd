...
```{r initialization-png, fig.cap = "Typical model initialization sequence", out.width = "450px", echo = FALSE}
knitr::include_graphics("diagrams/initialization.png")
```

```{r timestep-png, fig.cap = "Typical model time step sequence", out.width = "450px", echo = FALSE}
knitr::include_graphics("diagrams/timestep.png")
```
