...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pkpdsimulation.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pkpdsimulation ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/IndividualsFileReporter.o: IndividualsFileReporter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IndividualsFileReporter.o IndividualsFileReporter.cpp

${OBJECTDIR}/PkPdReporter.o: PkPdReporter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PkPdReporter.o PkPdReporter.cpp
