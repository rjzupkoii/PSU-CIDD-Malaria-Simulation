...
for mda_round in number_MDA_round:
    for beta in betas:
        for importation in importations:                
            ...
            output_filename = 'FLAL_varied_importation_PFPR2_no_itc/%s/ONELOC_%s_%dRMDA_%s_OPPUNIFORM_FLAL_importation_%s.yml'%(kFormatter(popsize), kFormatter(popsize),mda_round,pfpr_str,importation_str);
