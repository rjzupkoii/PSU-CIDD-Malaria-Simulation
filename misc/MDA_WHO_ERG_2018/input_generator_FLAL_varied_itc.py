...
for mda_round in number_MDA_round:
    for beta in betas:
        for itc in itcs:                
            ...
            output_filename = 'FLAL_varied_itc/%s/ONELOC_%s_%dRMDA_%s_OPPUNIFORM_FLAL_itc_%s.yml'%(kFormatter(popsize), kFormatter(popsize),mda_round,pfpr_str,itc_str);
