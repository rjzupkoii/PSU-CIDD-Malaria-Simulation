...
stream = open('input_mmc_A4_mu_0p001983_interrupted_feeding_0p2.yml', 'r');
...
#                print(plas2, plas2_str, comp, comp_str, tc, tc_map['f'], beta, pfpr)
                ...
                ## save to file
                output_filename = 'A4_interrupted_feeding_0p2/input_mmc_A4_mu_0p001983_plas2_%s_comp_%s_tc_%s_pfpr_%s.yml'%( plas2_str, comp_str, tc_map['f'], pfpr);
