...
stream = open('input_mmc_A6b_mu_0p001983_interrupted_feeding_0p2.yml', 'r');
...
#%%
for lu, lu_str in lumefantrine_mutant_introductions.items():    
...
#                print(plas2, plas2_str, comp, comp_str, tc, tc_map['f'], beta, pfpr)
                ...
                for index,event in enumerate(data['events']):
                    if event['name'] == 'introduce_lumefantrine_mutant_parasites':
                        new_data['events'][index]['info'][0]['fraction'] = lu
                ...
                ## save to file
                output_filename = 'A6_interrupted_feeding_0p2/input_mmc_A6_mu_0p001983_lumefantrine_mutant_%s_comp_%s_tc_%s_pfpr_%s.yml'%( lu_str, comp_str, tc_map['f'], pfpr);
