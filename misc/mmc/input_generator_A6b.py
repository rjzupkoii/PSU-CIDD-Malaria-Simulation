...
stream = open('input_mmc_A6b_mu_0p001983.yml', 'r');
...
#                print(plas2, plas2_str, comp, comp_str, tc, tc_map['f'], beta, pfpr)
                ...
                ## save to file
                output_filename = 'A6b/input_mmc_A6_mu_0p001983_lumefantrine_mutant_%s_comp_%s_tc_%s_pfpr_%s.yml'%( lu_str, comp_str, tc_map['f'], pfpr);
