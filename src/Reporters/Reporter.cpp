...
Reporter *Reporter::MakeReport(ReportType report_type) {
  switch (report_type) {
    ...
    case AMU:return new AMUReporter();
    case FARM:return new FarmReporter();
    case MULTIPLE_LOCATION:return new MultipleLocationGuiReporter();
    case YEARLY_REPORTER_V1:return new YearlyReporterV1("yearly_output.txt");
    case MONTHLY_REPORTER:return new MonthlyReporterConsole();
    case BURNIN_MONTHLY_REPORTER:return new BurninMonthlyReporter();
    case BURNIN_FARM_REPORTER:return new BurninFarmReporter();
    case BFREPORTER:return new BFMonthlyReporter();
    case BFFARM_REPORTER:return new BFFarmReporter();
