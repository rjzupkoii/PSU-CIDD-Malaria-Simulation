...
void CellularReporter::initialize(int job_number, std::string path) {
    ...
    aggregate_reporter.setGlobally(el::ConfigurationType::Filename, fmt::format("{}monthly_data_{}.txt", path, job_number));
    ...
    detail_reporter.setGlobally(el::ConfigurationType::Filename, fmt::format("{}monthly_data_{}.txt", path, job_number));
