...
Drug::Drug(DrugType *drug_type) : drug_type_(drug_type), dosing_days_(0), last_update_time_(0), last_update_value_(1.0),
                                  starting_value_(1.0), start_time_(0), end_time_(0), person_drugs_(nullptr) {
}
...
//            return starting_value_;
    ...
    double temp = NumberHelpers::is_equal(drug_type_->drug_half_life(), 0.0) ? -100 : -(days - dosing_days_) *
                                                                                      log(2) /
